                ...
                iconListData.map((item)=>{
                    return (
                        <TouchableOpacity key={item.id} style={{padding: 10}} onPress={()=>{}}>
                            <Image source={{uri: 'https://res.cloudinary.com/sushilmandi/image/upload/v1608034776/country-flag-png/guam_h5c28e.png'}} style={{width: 50, height: 50}} resizeMode="contain"/>
                        </TouchableOpacity>
                    )
                })
            }
