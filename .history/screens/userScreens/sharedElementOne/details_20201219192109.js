      ...
      <Animated.View style={{
          ...
          <Animated.FlatList
            ...
            onMomentumScrollEnd={(ev) => {
              ...
              const newIndex = Math.floor(ev.nativeEvent.contentOffset.x / windowWidth * 2);

              console.log('scroll ended newIndex  :   ', ev.nativeEvent.contentOffset.x);
              console.log('scroll ended newIndex  :   ', windowWidth);
