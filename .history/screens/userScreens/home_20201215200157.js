 ...
 const HomeScreen = (props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      >Welcome to {route.name} Screen<Image source={{uri: 'https://res.cloudinary.com/sushilmandi/image/upload/v1608034776/country-flag-png/guam_h5c28e.png'}} style={{width: 100, borderWidth: 5, borderColor: 'black'}} resizeMode="contain"/></Text>
