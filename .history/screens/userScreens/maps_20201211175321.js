  ...
  return (
    ...
    //   mapType="hybrid" 
      ...
      >
        ...
        anchor={{x: 0.5, y: 0.5}}
        >
          <Image source={require('../../assets/map/marker-car.png')}/>
        </Marker> : <Marker 
        coordinate={{
          latitude: 22.7288425,
          longitude: 88.4937687,
        ...
        {/* <Marker coordinate={{latitude: 22.7288425, longitude: 88.4937687}}>
          <Image source={require('../../assets/map/marker-car.png')} style={{height: 50, width:50 }}/>
        </Marker> */}
      </MapView>
