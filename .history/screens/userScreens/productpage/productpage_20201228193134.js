    ...
    try {
      ...
      if(tokenData) {
        ...
        let a = {
          ...
          body: {customerStripeID: null, stripeToken: tokenData.tokenId, amount: 15.00}, 
        ...
        HTTP_POST_REQUEST_BACKEND_API(a).then(data => {
          ...
          if(data.status){
            console.log('success payment data  :  ', data.data);
          }else{
            console.log('success payment data  :  ', json.stringify(data.data.error));
          }
        }).catch(err => {
