    ...
    <View style={styles.container}>
      ...
      <View style={{ 
          ...
          paddingHorizontal: 10
              ...
              <Text>The Nike Air Max 270 amps up an icon with a huge Max Air unit for cushioning under every steps. It features a stretchy inner sleeve for a snug, sock-like fit.</Text>
          </View>
