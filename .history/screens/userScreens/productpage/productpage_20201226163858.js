  ...
  async function onPressProceedPayment() {
    ...
    try {
      ...
      if(tokenData) {
        ...
        let a = {URL: '/stripe/getpayment', body: {customerStripeID: null, stripeToken: tokenData.tokenId, amount: 15.00}, isTokenRequired: false}
        console.log(a);

        HTTP_POST_REQUEST_BACKEND_API(a).then(data => {
          console.log('err payment body  :  ', data);
        }).catch(err => {
