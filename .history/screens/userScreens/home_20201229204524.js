...
import { StyleSheet, Text, View, TouchableOpacity, Button, Image, ScrollView, BackHandler, Alert, StatusBar } from 'react-native';
 ...
 const HomeScreen = (props) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollcontainer} showsVerticalScrollIndicator={false}>
      ...
      <ButtonTypeOne onpress={onPressHome10} text='Stripe Payment'/>
