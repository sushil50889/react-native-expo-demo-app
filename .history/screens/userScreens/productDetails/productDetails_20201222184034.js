...
const renderHeader = () => (
    <View style={{alignItems: 'center', alignContent: 'center', borderRadius: 20, marginTop: statusBarHeight * 1.2, paddingVertical: 8}}>
      <View style={{width: width * 0.3, height: 5, backgroundColor: '#9c9392', borderRadius: 20}}/>
    </View>
);
