...
const renderHeader = () => (
    <View style={{alignItems: 'center', alignContent: 'center', borderRadius: 20, marginTop: statusBarHeight*1.15, paddingVertical: 6}}>
      <View style={{width: width * 0.2, height: 5, backgroundColor: '#9c9392', borderRadius: 20}}/>
    </View>
);
