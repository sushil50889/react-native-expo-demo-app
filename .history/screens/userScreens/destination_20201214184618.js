...
import { setDestinationLocationData, setOriginLocationData } from '../../redux-configuration/actions';
...
function DestinationScreen({ navigation, route, destLocationDispatch, originLocationDispatch }) {
