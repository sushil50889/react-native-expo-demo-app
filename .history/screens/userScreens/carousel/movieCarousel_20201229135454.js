...
const Loading = () => (
  <View style={styles.loadingContainer}>
    ...
    {/* <LottieView
          ...
          // source={require('../../../assets/lottijson/rubiks-cube.json')}
          source={{
            uri: 'https://assets8.lottiefiles.com/packages/lf20_rpc9klrq.json'
          }}
    /> */}
      <Video
        source={require('../../../assets/lottijson/santa-surprise-gift.mp4')}
        rate={1.0}
        volume={1.0}
        isMuted={true}
        resizeMode="cover"
