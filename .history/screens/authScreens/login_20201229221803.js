...
const Login_Screen = function (props) {
  ...
  const emailPlaceholder = React.useRef('Email...');
  const passwordPlaceholder = React.useRef("Password...");
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputView} >
          <TextInput  
            ...
            placeholder={emailPlaceholder.current}
            placeholderTextColor="#003f5c"
            onChangeText={text => {emailPlaceholder.current = ''; setEmail(text)}}
